...
const TotalSalesOfCurrentMonth = ({ totalSalesAndOrders }) => {
    ...
    return (
        <div className='col-md-5 mt-5 mx-5 bg-info p-3 mb-5 text-left text-white d-flex justify-content-center align-items-center' style={{ borderRadius: '7px' }}>
            <div className='my-4'>
                <img src={logo} alt="" className='m-3' style={{ width: '250px', height: '250px' }} />
            </div>
            <div className='p-5 bg-danger' style={{ border: '6px solid #fff', borderRadius: '7px' }}>
                <h3 className='mb-4'><strong>{months[new Date().getMonth()]}</strong></h3>
                <h5 className='mb-4'> <strong>Total Sales: {totalSalesAndOrders.totalSales} Taka</strong> </h5>
