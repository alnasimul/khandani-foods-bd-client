...
import './TotalSalesOfCurrentMonth.css';

const TotalSalesOfCurrentMonth = ({ totalSalesAndOrders }) => {
    const months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    return (
        <div className='col-md-4 mt-5 mx-5 bg-light p-3 mb-5 text-left text-white d-flex justify-content-center align-items-center salesCurrentMonth' style={{ borderRadius: '7px' }}>
            <div className='my-4 calculationImage'>
