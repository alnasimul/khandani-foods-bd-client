...
const Orders = () => {
    ...
    const getPaymentStatus= (id,status) => {
        ...
        if(id){
            ...
            fetch(`https://khandani-foods-bd-server-render.onrender.com/updateStatus/${id}?email=${userInfo.email}`,{
                method:'PATCH',
                headers: {
    ...
    const deleteOrder = id => {
        if(id){
            fetch(`https://khandani-foods-bd-server-render.onrender.com/deleteOrder/${id}?email=${userInfo.email}`,{
                method: 'DELETE',
                headers: {
                    'Content-Type' : 'application/json',
                    authorization: `Bearer ${sessionStorage.getItem('token')}`
    ...
    useEffect(() => {
        fetch(`https://khandani-foods-bd-server-render.onrender.com/getOrders?email=${userInfo.email}`,{
            method: 'GET',
            headers: {
                'Content-Type' : 'application/json',
                authorization: `Bearer ${sessionStorage.getItem('token')}`
